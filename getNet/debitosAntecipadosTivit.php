...
function debitosAntecipados($linha, $pdo, $coluna)
{
	...
	$coluna->setDataPagamentoRo(convertData(substr($linha, 40,8)));
	...
	$coluna->setDataPagamentoAjuste(convertData(substr($linha, 91,8)));
	...
	inserirDebitosAntecipacaoTivit($pdo, $coluna);
}
